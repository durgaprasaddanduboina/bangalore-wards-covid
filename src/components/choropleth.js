      ...
      newsvg
        ...
        .on('mouseover', (d) => {
          ...
          const html1 =
            ...
            '</li>' +
            "<li style='padding:0px 15px'><span>Reported: </span>" +
            value.Point_Count +
            '</li>' +
            "<li style='padding:0px 15px'><span>Active: </span>" +
            (value.Point_Count - value.Recovered - value.Death) +
            '</li>' +
            "<li style='padding:0px 15px'><span>Recovered: </span>" +
            value.Recovered +
            '</li>' +
  ...
  return (
    <div className="svg-container svg-parent">
      ...
      <div className="map-stats">
        <div className="stats">
          <p>
            <span className="border-bottom">Rajasthan Status</span>
          </p>
